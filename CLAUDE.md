...
>
> **After writing code, always verify compilation** by running module tests via `xcodebuild test -workspace Challenge.xcworkspace -scheme "Challenge (Dev)" -destination 'platform=iOS Simulator,name=iPhone 17 Pro,OS=latest'`.
>
